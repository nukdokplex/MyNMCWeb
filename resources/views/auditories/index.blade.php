@extends('layouts.app', ['title' => "Аудитории", 'tab' => 'auditories'])
@section('content')
    <!-- Top navbar -->
        ...
        $(document).ready(function (){
            ...
            var auditoriesTable = $("#auditories-datatable").DataTable({
                ...
                onAddRow: function (datatable, rowdata, success, error) {
                    $.ajax({
                        url: '{{route('ajax.auditories.create', ['_token' => csrf_token()])}}',
                        type: 'PUT',
                ...
                onDeleteRow: function (datatable, rowdata, success, error) {
                    $.ajax({
                        url: '{{route('ajax.auditories.delete', ['_token' => csrf_token()])}}',
                        type: 'DELETE',
                        data: JSON.stringify(rowdata),
                        success: success,
                        error: error
                ...
                onEditRow: function (datatable, rowdata, success, error) {
                    $.ajax({
                        url: '{{route('ajax.auditories.update', ['_token' => csrf_token()])}}',
                        type: 'POST',
                        data: JSON.stringify(rowdata),
                        success: success,
                        error: error
